				...
				<div class="modal-body" id="myModalReservasBody">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="form-group col-md-4" id="fgfecha">
								...
								<script type="text/javascript">$(function () { 
									$('#fecha').datetimepicker({ minDate:new Date(),locale: 'es',allowInputToggle: true, format: 'DD/MM/YYYY',showClear: true, showClose: true }); });</script>
							</div>	
							<div class="form-group col-md-4" id="fgpaseo">
			                    <label class="control-label" for="paseo" id="lblpaseo">Tipo de Paseo:</label>
			                  	<?php 
			                    	$attr = "class='form-control' id='paseo' onchange=checkCantPaxReservas(true)";
			                    	echo form_dropdown('tipo_serv',$tpserv,'',$attr) ;
			                    	?>
			                </div>
			                <div class="form-group col-md-4" id="fghora" >
			                  <label class="control-label" for="hora" id="lblhora">Hora Salida:</label>
			                  <?php 
			                    	$attr = "class='form-control' id='hora' ";
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="form-group col-md-4" id="fgpax" >
			                  <label class="control-label" for="pax" id="lblpax">Cantidad pasajeros</label>
			                  <input class="form-control" id="pax" onchange="checkCantPaxReservas(false)" type="number" placeholder="ingresar cantidad pax" min="0">
			                </div>
			                <div class="form-group col-md-4">
			                  <label class="control-label" for="senia" id="lblsenia">Pagado </label>
			                  <input class="form-control" id="senia" type="number" placeholder="ingresar monto en pesos" min="0" onchange="checkCantPaxReservas(false)">
			                </div>
			                <div class="form-group col-md-4" >
			                  <label class="control-label" for="saldo" id="lblsaldo">Saldo</label>
			                  <input class="form-control" id="saldo" type="number" disabled value=0 min="0">
			                </div>
							<div class="form-group col-md-4" id="fgcliente" >
								<label class="control-label" for="cliente">Nombre del Contratante</label>
								<input class="form-control" type="text" name="cliente" id="cliente"/>
								
							</div>
							<div class="form-group col-md-4" id="fgemail">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="form-group col-md-8">
								<label class="control-label" for="detalle">Detalle del servicio</label>
								<textarea class="form-control" type="textarea" maxlength="150" rows='4' id='detalle' ></textarea>	
							</div>
